...
KOBJS := assert.o main.o math.o memcheck.o raise.o ctype.o hexdump.o device.o setIRQStack.o setUserConditions.o S_Handler.o C_SWI_Handler.o C_IRQ_Handler.o
KOBJS := $(KOBJS:%=$(KDIR)/%)
